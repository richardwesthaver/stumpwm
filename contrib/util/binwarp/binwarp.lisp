...
(defmacro define-binwarp-mode (name key
                               (&key
                                  ...
                                  (on-enter '#'swm/binwarp:init-binwarp)
                                  (on-exit  '#'swm/binwarp:exit-binwarp)
...
\(swm/binwarp:define-binwarp-mode binwarp-mode \"s-m\"
...
\(swm/binwarp:define-binwarp-mode binwarp-mode
  \"M\" (:map *root-map*
      :redefine-bindings t)
  ((kbd \"a\") \"binwarp left\")
  ((kbd \"w\") \"binwarp up\")
